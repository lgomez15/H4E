  ...
  <div>
    ...
    <transition name="modal">
      <div
        ...
        class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70 overflow-y-auto"
      >
        <div class="bg-white rounded-lg shadow-lg w-full max-w-4xl p-6 relative flex flex-col max-h-screen">
          <!-- Encabezado del Modal -->
          <div class="flex justify-between items-center mb-4">
            <h2 class="text-2xl font-bold text-gray-900">{{ estudianteSeleccionado.nombre }} {{ estudianteSeleccionado.apellido }}</h2>
            <button
    ...
    <!-- Resto del contenido de Dashboard.vue -->
          ...
          <div v-if="claseSeleccionada" class="bg-white shadow overflow-hidden sm:rounded-md">
            <ul role="list" class="divide-y divide-gray-200">
              <li
                ...
                :key="estudiante.id"
                class="px-4 py-4 sm:px-6 cursor-pointer hover:bg-gray-50"
                @click="seleccionarEstudiante(estudiante.id)"
              >
